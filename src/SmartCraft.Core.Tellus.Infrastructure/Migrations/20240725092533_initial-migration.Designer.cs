...
namespace SmartCraft.Core.Tellus.Infrastructure.Migrations
{
    ...
    [Migration("20240725092533_initial-migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartCraft.Core.Tellus.Infrastructure.Models.VehicleEvaluation", b =>
                {
                    ...
                    b.Property<Guid?>("VehicleEvaluationReportId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("VehicleEvaluationReportId");

                    b.ToTable("VehicleEvaluations");
                });

            modelBuilder.Entity("SmartCraft.Core.Tellus.Infrastructure.Models.VehicleEvaluationReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VehicleEvaluationReports");
                });
            ...
            modelBuilder.Entity("SmartCraft.Core.Tellus.Infrastructure.Models.VehicleEvaluation", b =>
                {
                    b.HasOne("SmartCraft.Core.Tellus.Infrastructure.Models.VehicleEvaluationReport", null)
                        .WithMany("VehicleEvaluations")
                        .HasForeignKey("VehicleEvaluationReportId");
                });
