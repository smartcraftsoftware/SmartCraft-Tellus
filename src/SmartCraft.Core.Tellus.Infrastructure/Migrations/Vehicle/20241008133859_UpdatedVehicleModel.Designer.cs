...
namespace SmartCraft.Core.Tellus.Infrastructure.Migrations.Vehicle
{
    ...
    [Migration("20241008133859_UpdatedVehicleModel")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartCraft.Core.Tellus.Infrastructure.Models.Vehicle", b =>
                {
                    ...
                    b.Property<int?>("NoOfAxles")
                        .HasColumnType("integer");

                    b.Property<List<string>>("PossibleFuelTypes")
                        .HasColumnType("text[]");

                    b.Property<Guid?>("ProductionDateId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SmartCraft.Core.Tellus.Infrastructure.Models.VehicleProductionDate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VehicleProductionDate");
                });

            modelBuilder.Entity("SmartCraft.Core.Tellus.Infrastructure.Models.Vehicle", b =>
                {
                    b.HasOne("SmartCraft.Core.Tellus.Infrastructure.Models.VehicleProductionDate", "ProductionDate")
                        .WithMany()
                        .HasForeignKey("ProductionDateId");

                    b.Navigation("ProductionDate");
                });
