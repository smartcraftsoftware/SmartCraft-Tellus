...
{
    private readonly Mock<Microsoft.Extensions.Logging.ILogger<TenantController>> loggerMock = new();
    ...
    {
        return new TenantController(loggerMock.Object, tenantServiceMock.Object);
    }
}
